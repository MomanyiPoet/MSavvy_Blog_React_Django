...
import cover from "../../assets/images/bg1.webp";
            ...
            <Link to={`/article/${article.id}`} key={article.id}>
                <div className="row py-2">
                    ...
                    <div className="col-sm-10 col-8 d-flex flex-column align-items-start justify-content-center">
                        ...
                        <h6 className="px-xl-2 text-xs opacity-6 text-end">{new Date(article.postdate).toLocaleString('en-US', { year: 'numeric', month: '2-digit', day: '2-digit'})} <i className="fas fa-clock text-xxs"></i> {article.readingtime} mins read</h6>
                    </div>
                    <div>
