                ...
                <div className="col-12">
                    <nav className="navbar navbar-expand-lg navbar-transluscent blur border-radius-xl top-0 z-index-fixed shadow position-absolute py-2 start-0 end-0 mx-4">
                        <div className="container-fluid px-0">
                            <a href="#header" class="navbar-brand fw-bolder text-lg">
                            ...
                            <div className="collapse navbar-collapse pt-3 pb-2 py-lg-0 w-100" id="navigation">
                                <ul className="navbar-nav navbar-nav-hover ms-auto align-items-center">
                                    <li className="nav-item">
                                        <a href="#header" class="nav-link ps-2 d-flex cursor-pointer"
                                            aria-expanded="false">Home</a>
                                    </li>
                                    <li className="nav-item">
                                        <a href="#categories" class="nav-link ps-2 d-flex cursor-pointer"
                                            aria-expanded="false">Topics</a>
                                    </li>
                                    <li className="nav-item">
                                        <a href="#features" class="nav-link ps-2 d-flex cursor-pointer"
                                            aria-expanded="false">Featured Posts</a>
                                    </li>
                                    <li className="nav-item">
                                        <a href="#recents" class="nav-link ps-2 d-flex cursor-pointer"
                                            aria-expanded="false">Recent Posts</a>
                                    </li>
                                    <li className="nav-item">
                                        <a href="#contact" class="nav-link ps-2 d-flex cursor-pointer"
                                            aria-expanded="false">Contact</a>
                                    </li>
                                    <li className="nav-item nav-link">
                                        <a href="#header" class="btn btn-sm bg-gradient-dark mb-0 me-1 mt-md-0 mt-2"
