                                ...
                                <div className="card-header p-0 position-relative">
                                    ...
                                    <hr className="border border-dark border-1 opacity-2" />
                                        <div className="d-flex justify-content-between opacity-6">
                                            <h6 className="text-sm">Posted on {new Date(article.postdate).toLocaleString('en-US', { year: 'numeric', month: '2-digit', day: '2-digit'})}</h6>
                                            <h6 className="text-sm"><i className="fas fa-clock text-xs"></i> {article.readingtime} mins read</h6>
                                        </div>
