              ...
              <div class="card card-plain shadow-xl pt-2 px-3 my-3" key={article.id}>
                  <div class="card-header p-0 position-relative">
                      ...
                      <div class="mt-3 d-flex justify-content-between">
                          ...
                          <h6 class="text-xs opacity-6"><i class="fas fa-clock text-xxs"></i> {article.readingtime} mins read</h6>
                      </div>
                  </div>
                      ...
                      <div class="d-flex justify-content-between align-items-end">
                          <div class="row">
                              ...
                              <div class="col-8 d-flex align-items-end ms-n1">
                                  <p class="text-xs fw-bold">{article.author} <br /> {new Date(article.postdate).toLocaleString('en-US', { year: 'numeric', month: '2-digit', day: '2-digit'})}</p>
                              </div>
                          </div>
